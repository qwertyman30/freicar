...
# from . import freicar_segreg_dataloader as loader
########################################################################
...
## uncommented this block so that it wont run with publish_images.py

# static_data = loader.FreiCarLoader("../../data/", padding=(0, 0, 0, 0),
#                                    split='validation', load_real=False)

# static_data = freicar_segreg_dataloader.FreiCarLoader("../../data/", padding=(0, 0, 0, 0),
#                                    split='validation', load_real=False)
#
